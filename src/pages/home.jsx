    ...
    <>
      ...
      <section id="gallery-section">
        ...
        <button  id="cursor_default" className="gallery_btn">
          <Link to={"/gallery"} className="btn bg-color-primary-blue color-white">
            Visit Gallery
          </Link>
        </button>
      </section>
      ...
      <section id="testimonials-section">
        <div className="heading">
          <h1 className="header-font-700">Testimonials</h1>
          <p className="body-font-500">Hear From Our Community</p>
        </div>
      ...
      <div
        className="connect-button bg-color-primary-blue color-white"
        id="connect-button"
      >
        <a
